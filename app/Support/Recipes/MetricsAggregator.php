...
class MetricsAggregator
{
    ...
    private function prepareIngredientLine(array $lineData, Collection $ingredients, Collection $units): array
    {
        ...
        return [
            ...
            'saturated_fat_g' => $this->ingredientValue($ingredient, 'saturated_fat_g'),
            'carbs_g' => $this->ingredientValue($ingredient, 'carbs_g'),
            'fibre_g' => $this->ingredientValue($ingredient, 'fibre_g'),
            'sodium_mg' => $this->ingredientValue($ingredient, 'sodium_mg'),
    ...
    private function prepareSubRecipeLine(array $lineData): array
    {
        ...
        return [
            ...
            'saturated_fat_g' => $scaledNutrition['saturated_fat_g'] ?? null,
            'carbs_g' => $scaledNutrition['carbs_g'] ?? null,
            'fibre_g' => $scaledNutrition['fibre_g'] ?? null,
            'sodium_mg' => $scaledNutrition['sodium_mg'] ?? null,
